              ...
              <table class="result-tab" width="100%">
                ...
                <tr v-for="(book,index) in this.bookList" :key="index">
                  ...
                  <td>
                    ...
                    <a class="link-del pointer margin-right" @click="deleteBook(book.id)">删除</a>
                    <a  @click="test1(book,index)"><i class="el-icon-circle-plus-outline"></i></a>
                  </td>
                </tr>
              </table>
